...
import dashboardService from '@/app/(shared)/services/trainer/dashboardService'
...
function MetricSection() {
  ...
  const [timeFrame, setTimeFrame] = useState<
    'seven-days' | 'weekly' | 'monthly' | 'yearly'
  >('seven-days')
  ...
  const handleTimeFrameChange = (value: string) => {
    setTimeFrame(value as 'seven-days' | 'weekly' | 'monthly' | 'yearly')
  }
