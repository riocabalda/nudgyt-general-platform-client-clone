...
function TemplateInfiniteScroll() {
  ...
  const getKey = (pageIndex: number, previousPageData: any | null) => {
    ...
    if (simulationType) queryParams.append('simulation_type', simulationType)
        ...
        {servicesData.map((serviceData) => (
          <li key={serviceData._id}>
            <ServiceCard
              ...
              link={`/trainer/services/${serviceData._id}`}
            />
          </li>
        ))}
...
export default TemplateInfiniteScroll
