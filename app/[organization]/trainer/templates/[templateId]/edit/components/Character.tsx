...
import { useGetCharacters } from '../../../create/hooks/useGetCharacters'
    ...
    <div className='px-4 lg:px-0 pt-0 lg:py-10 max-w-[712px] mx-auto'>
      ...
      <Card className='max-w-5xl mx-auto p-4 mt-[40px]'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg gap-6'>
          <Card className='bg-gray-50 border border-neutral-gray-400'>
            <div className='divide-y overflow-auto max-h-[340px] scrollbar-thin'>
              {availableCharacters.map((character: any, index: number) => (
                <Label
                  key={character._id}
                  className={cn(
                ...
                >
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        const newCharacterIds =
                          characterIds?.filter((id) => id !== character._id) ||
                          []
                        setCharacterIds(newCharacterIds)
                        if (newCharacterIds.length <= selectedCharacterIndex) {
                  ...
                  <div className='shrink-0 size-[40px] overflow-hidden bg-muted rounded-full'>
                    <Image
          ...
          <div className='col-span-1 sm:col-span-2'>
            ...
            <Card className='p-6 min-h-[340px] overflow-auto border border-neutral-gray-400'>
              {selectedCharacters.length > 0 ? (
                <div className='space-y-6'>
                  <div className='flex justify-between'>
                    ...
                    <Button
                      variant='outline'
                      className='text-sm border rounded-lg hover:bg-gray-50 h-[32px]'
                    >
                      Edit
                    </Button>
                  </div>
