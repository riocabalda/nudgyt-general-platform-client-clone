  ...
  return (
    <>
      <Button asChild variant='outline' className='hidden lg:flex'>
        <Link href={`/${orgSlug}/trainer/account/personal-details`}>
          Edit Profile
        </Link>
      </Button>

      <Button asChild variant='outline' className='lg:hidden'>
        <Link href={`/${orgSlug}/trainer/account/mobile/personal-details`}>
          Edit Profile
        </Link>
      </Button>
    </>
...
function ChangePasswordLink() {
  ...
  return (
    <>
      <Button asChild variant='outline' className='hidden lg:flex'>
        <Link href={`/${orgSlug}/trainer/account/change-password`}>
          Change Password
        </Link>
      </Button>

      <Button asChild variant='outline' className='lg:hidden'>
        <Link href={`/${orgSlug}/trainer/account/mobile/change-password`}>
          Change Password
        </Link>
      </Button>
    </>
