...
import useGetSharedTemplates from '../hooks/useGetSharedTemplates'
...
function ExistingRubricsLink() {
  ...
  const href: string | undefined = selectedTemplate?.rubrics?.file ?? undefined
...
function ExistingFormAnswersLink() {
  ...
  const href = selectedTemplate?.form_questions_file ?? undefined
  const linkText = href === undefined ? undefined : getLastUrlSegment(href)
    ...
    <div className='px-4 lg:px-0 pt-0 lg:py-10 max-w-[712px] mx-auto'>
      ...
      <Label
        className={cn(
          ...
          (isTemplate || !!templateId || !!templateIdFromUrl) &&
      ...
      >
        <div className='flex items-start'>
          <Checkbox
            ...
            checked={isTemplate || !!templateId}
            onCheckedChange={(checked) => {
              setIsTemplate(checked as boolean)
              if (!checked) {
                resetServiceForm()
              }
            }}
        ...
        {(isTemplate || templateId || templateIdFromUrl) && (
          <Select
            ...
            value={templateIdFromUrl ?? templateId ?? undefined}
          >
