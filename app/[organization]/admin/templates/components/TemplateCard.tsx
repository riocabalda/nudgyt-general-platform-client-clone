...
function TemplateCard({ templateData, type, link }: any) {
  const admin = 'admin'
  const { user } = useUser()
        ...
        <div className='relative pb-[32%]'>
          {isCreator && (
            <ServiceStatusBadge
              ...
              className={cn(
                'absolute z-[3] right-24 top-4',
                !templateData?.is_master_template && 'right-4 top-4'
              )}
            />
          )}
        ...
        <div className='p-4 flex flex-col h-full'>
          ...
          <div className='flex items-end justify-between'>
            <div>
              ...
              {type === admin && templateData.creator && (
