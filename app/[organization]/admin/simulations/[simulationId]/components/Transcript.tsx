...
function Transcript({ serviceData }: { serviceData: Service }) {
  ...
  return (
    <>
      <Card
        ref={containerRef}
        className='flex-1 flex flex-col p-4 lg:pb-4 gap-4 w-full rounded-none rounded-t-[8px] border border-b-0 overflow-y-auto scrollbar-thin'
      >
      ...
      <Card className='mb-[74px] pl-4 pr-2 py-2 lg:mb-0 w-full rounded-none lg:rounded-b-[8px] border-t lg:border '>
        ...
        <div className='min-h-14 flex items-center gap-3'>
          <TextareaAutosize
            ...
            ref={textAreaRef}
            className={cn(
              'w-full  p-0 resize-none border-none scrollbar-thin active:outline-none focus:outline-none focus:ring-transparent',
