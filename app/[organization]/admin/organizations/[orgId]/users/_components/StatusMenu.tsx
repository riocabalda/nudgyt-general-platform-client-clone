...
function StatusMenu({
  ...
  const { mutate: currentUserMutate } = useGetUser(viewedOrgSlug, user._id)
  ...
  const handleApproveClick = async () => {
    ...
    if (confirmed) {
      ...
      try {
        await userService.approveUser(viewedOrgSlug, user._id)
  ...
  const handleBlockClick = async () => {
    ...
    if (confirmed) {
      ...
      try {
        await userService.blockUser(viewedOrgSlug, user._id)
  ...
  const handleUnblockClick = async () => {
    ...
    if (confirmed) {
      ...
      try {
        await userService.unblockUser(viewedOrgSlug, user._id)
