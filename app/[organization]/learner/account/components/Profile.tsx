  ...
  return (
    <>
      <Button asChild variant='outline' className='hidden lg:flex'>
        <Link href={`/${orgSlug}/learner/account/personal-details`}>
          Edit Profile
        </Link>
      </Button>

      <Button asChild variant='outline' className='lg:hidden'>
        <Link href={`/${orgSlug}/learner/account/mobile/personal-details`}>
          Edit Profile
        </Link>
      </Button>
    </>
...
function ChangePasswordLink() {
  ...
  return (
    <>
      <Button asChild variant='outline' className='hidden lg:flex'>
        <Link href={`/${orgSlug}/learner/account/change-password`}>
          Change Password
        </Link>
      </Button>

      <Button asChild variant='outline' className='lg:hidden'>
        <Link href={`/${orgSlug}/learner/account/mobile/change-password`}>
          Change Password
        </Link>
      </Button>
    </>
...
function ProfileAvatar() {
  ...
  return (
    <Avatar className='size-20'>
      ...
      <AvatarFallback className='text-white bg-[#F3706F] text-4xl'>
