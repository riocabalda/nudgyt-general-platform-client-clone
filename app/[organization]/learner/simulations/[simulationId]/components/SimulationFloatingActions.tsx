    ...
    <div className='lg:static h-14 flex items-end gap-3 pl-4 pr-2 rounded-none lg:rounded-b-[8px]'>
      {showTextField && (
        <div ref={containerRef} className='relative'>
          ...
          <Textarea
            ref={inputRef}
            className='text-sm border-none max-h-[36px] bg-neutral-gray-800/75 text-white w-[75vw] lg:w-[365px] custom-scrollbar-thin focus-visible:ring-transparent focus-visible:ring-offset-transparent resize-none'
            placeholder={
